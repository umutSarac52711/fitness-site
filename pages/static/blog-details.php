...
<!-- Blog Details Hero Section Begin -->
    <section class="blog-details-hero set-bg" data-setbg="<?= BASE_URL ?>/assets/img/blog/details/details-hero.jpg">
        <div class="container">
            <div class="row">
                    ...
                    <div class="blog-details-text">
                        ...
                        <div class="blog-details-pic">
                            <div class="blog-details-pic-item">
                                <img src="<?= BASE_URL ?>/assets/img/blog/details/details-1.jpg" alt="">
                            </div>
                            <div class="blog-details-pic-item">
                                <img src="<?= BASE_URL ?>/assets/img/blog/details/details-2.jpg" alt="">
                            </div>
                        </div>
                        ...
                        <div class="blog-details-quote">
                            <div class="quote-icon">
                                <img src="<?= BASE_URL ?>/assets/img/blog/details/quote-left.png" alt="">
                            </div>
                        ...
                        <div class="blog-details-author">
                            <div class="ba-pic">
                                <img src="<?= BASE_URL ?>/assets/img/blog/details/blog-profile.jpg" alt="">
                            </div>
                            <div class="ba-text">
                                <h5>Lena Mollein.</h5>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                            ...
                            <div class="col-lg-6">
                                <div class="comment-option">
                                    ...
                                    <div class="co-item">
                                        ...
                                        <div class="co-pic">
                                            <img src="<?= BASE_URL ?>/assets/img/blog/details/comment-1.jpg" alt="">
                                    ...
                                    <div class="co-item reply-comment">
                                        ...
                                        <div class="co-pic">
                                            <img src="<?= BASE_URL ?>/assets/img/blog/details/comment-2.jpg" alt="">
                                            <h5>Brandon Kelley</h5>
                                        </div>
                                        <div class="co-text">
                                            <p>Neque porro quisquam est, qui dolorem ipsum dolor sit amet, consectetur,
                                    ...
                                    <div class="co-item">
                                        ...
                                        <div class="co-pic">
                                            <img src="<?= BASE_URL ?>/assets/img/blog/details/comment-3.jpg" alt="">
                                            <h5>Brandon Kelley</h5>
                                        </div>
                                        <div class="co-text">
                                            <p>Neque porro quisquam est, qui dolorem ipsum dolor sit amet, consectetur,
