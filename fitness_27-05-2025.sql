...
(6, 14, 5, 'commemtn', '2025-05-27 10:28:35'),
(9, 14, 5, 'huhh', '2025-05-27 14:13:37');
...
CREATE TABLE `posts` (
  ...
  `tags` set('Fitness','Nutrition','Workout','Cardio','Strength Training','Yoga','Pilates','Wellness','Healthy Recipes','Weight Loss','Muscle Gain','Motivation','Gym Life','Home Workout','Stretching') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `progress_logs` (`id`, `user_id`, `date`, `weight`, `height`, `body_fat`, `notes`) VALUES
(1, 5, '2025-05-27', 80.00, 175.00, 30.00, 'I feel fat as fuck');
...
INSERT INTO `testimonials` (`id`, `name`, `quote`, `photo`, `rating`, `status`, `created_at`) VALUES
(3, 'Umut Saraç', 'This fitness website is great!', NULL, 5, 'approved', NULL);
...
INSERT INTO `users` (`id`, `full_name`, `email`, `password`, `role`, `created_at`, `is_active`, `username`, `phone_number`, `address`, `date_of_birth`, `profile_picture`, `membership_plan_id`, `membership_start_date`, `membership_end_date`, `updated_at`, `age`, `bio`) VALUES
(5, 'Umut Saraç', 'umut.sarac@tedu.edu.tr', '$2y$10$7.G3Fg/0nQXFC3iNC0a5Iu0wdIBC/.lGUCSMm.TRkiv6D9yO2pNaK', 'admin', '2025-05-24 09:05:47', 1, 'umutsarac', '+905359627717', 'everywhere bby', '2005-04-14', 'user_5_683163bd41d52.jpg', NULL, NULL, NULL, '2025-05-24 07:12:52', 0, NULL),
(10, 'RLefew D. Loee', 'rlefew.d.loee@example.com', 'yourPlaintextPassword123', 'trainer', '2025-05-26 04:46:08', 1, 'rlefewdloee', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-26 01:46:08', 30, NULL),
(11, 'Keaf Shen', 'keaf.shen@example.com', 'yourPlaintextPassword123', 'trainer', '2025-05-26 04:46:08', 1, 'keafshen', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-26 01:46:08', 30, NULL),
(12, 'Kimberly Stone', 'kimberly.stone@example.com', 'yourPlaintextPassword123', 'trainer', '2025-05-26 04:46:08', 1, 'kimberlystone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-26 01:46:08', 30, NULL),
(13, 'Rachel Adam', 'rachel.adam@example.com', 'yourPlaintextPassword123', 'trainer', '2025-05-26 04:46:08', 1, 'racheladam', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-26 01:46:08', 30, NULL),
(14, 'Robert Cage', 'robert.cage@example.com', 'yourPlaintextPassword123', 'trainer', '2025-05-26 04:46:08', 1, 'robertcage', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-26 01:46:08', 30, NULL),
(15, 'Donald Grey', 'donald.grey@example.com', 'yourPlaintextPassword123', 'trainer', '2025-05-26 04:46:08', 1, 'donaldgrey', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-26 01:46:08', 30, NULL);
